...
public class RegistryManagerTests extends IntegrationTest
{
    ...
    public void deviceCreationWithSecurityScope() throws IOException, InterruptedException, IotHubException
    {
        ...
        //-Create-//
        String expectedScope = "some-security-scope";
        ...
        Tools.addDeviceWithRetry(registryManager, edgeDevice);
        ...
        // Assert
        assertEquals(buildExceptionMessage("", hostName), deviceId, edgeDevice.getDeviceId());
        assertEquals(buildExceptionMessage("", hostName), deviceId, deviceRetrieved.getDeviceId());
        assertEquals(buildExceptionMessage("", hostName), expectedScope, edgeDevice.getScope());
        assertEquals(buildExceptionMessage("", hostName), expectedScope, deviceRetrieved.getScope());
    }
